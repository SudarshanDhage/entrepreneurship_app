...
Maeda — a professor in MIT's Media Lab and a world-renowned graphic designer — explores the question of how we can redefine the notion of "improved" so that it doesn't always mean something more.
...
## 21 Principles for Simplifying Design
...
### 9. Organization helps the system of many look fewer and more manageable
...
**As you will see for yourself counting the unorganized square of dots took considerably more time, and in addition to that put a much more cognitive load on you.** Why we had this result if the squares have an identical number of dots?
...
**Organization of elements not only improves recognition but also makes it easier to remember.** When operating any machine, it's very important to remember the position and function of all controls. When recalling the position of every dot, for majority recalling the unorganized structure is close to impossible.
...
**The key insight:** Simplicity is about removing difficulties on the way of users to their goals. It's not the absence of clutter—it's describing the purpose and place of an object. Focus on core value, remove unnecessary elements, support quick decisions, organize effectively, and design for the user's actual needs and context. Remember: fewer choices often lead to more conversions. Design for accessibility improves the experience for everyone.

---

**Sources:**
- [How to simplify your design](https://uxplanet.org/how-to-simplify-your-design-69d97fde11b9) - Taras Bakusevych, UX Planet, March 12, 2019
- "The Laws of Simplicity" by John Maeda
- Jonathan Ive quote
- Hick's Law
- The Jam Experiment (consumer psychology)
