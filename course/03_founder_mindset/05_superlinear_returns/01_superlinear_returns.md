...
Teachers and coaches implicitly told us the returns were linear. "You get out what you put in," we heard a thousand times. They meant well, but this is rarely true. **If your product is only half as good as your competitor's, you don't get half as many customers. You get no customers, and you go out of business.**

## It's a Feature of the World, Not Capitalism
...
It may seem as if there are a lot of different situations with superlinear returns, but they reduce to two fundamental causes: **exponential growth** and **thresholds**.
...
## How to Find Situations with Superlinear Returns

### Seek Work That Compounds

**The most obvious rule is to seek work that compounds.**

There are two ways work can compound. It can compound directly, in the sense that doing well in one cycle causes you to do better in the next. That happens for example when you're building infrastructure, or growing an audience or brand. **Or work can compound by teaching you, since learning compounds.**

This second case is an interesting one because you may feel you're doing badly as it's happening. You may be failing to achieve your immediate goal. But if you're learning a lot, then you're getting exponential growth nonetheless.
...
### Finding Promising Intellectual Thresholds

It would be great if there were a way to find promising intellectual thresholds. Is there a way to tell which questions have whole new fields beyond them? I doubt we could ever predict this with certainty, but the prize is so valuable that it would be useful to have predictors that were even a little better than random.

**We can to some degree predict when a research problem isn't likely to lead to new discoveries: when it seems legit but boring. Whereas the kind that do lead to new discoveries tend to seem very mystifying, but perhaps unimportant.** (If they were mystifying and obviously important, they'd be famous open questions with lots of people already working on them.)
...
**There's a surprising amount of technique to doing great work. It's not just a matter of trying hard.** Here's the recipe:
...
And there is of course one other thing you need: to be lucky. Luck is always a factor, but it's even more of a factor when you're working on your own rather than as part of an organization. **The solution is to take multiple shots. Which is another reason to start taking risks early.**

## Fields with Superlinear Returns
...
**When we exclude sports and politics and the effects of fame, a remarkable pattern emerges: the remaining list is exactly the same as the list of fields where you have to be independent-minded to succeed—where your ideas have to be not just correct, but novel as well.**
...
**In all of these fields you have to put in the initial effort. Superlinear returns seem small at first. At this rate, you find yourself thinking, I'll never get anywhere. But because the reward curve rises so steeply at the far end, it's worth taking extraordinary measures to get there.**
...
**There's another more subtle lesson: not to equate work with a job.** For most of the 20th century the two were identical for nearly everyone, and as a result we've inherited a custom that equates productivity with having a job. Even now to most people the phrase "your work" means their job. But to a writer or artist or scientist it means whatever they're currently studying or creating. For someone like that, their work is something they carry with them from job to job, if they have jobs at all. It may be done for an employer, but it's part of their portfolio.

**If you have sufficient natural ability and you follow your curiosity sufficiently far, you'll end up in a field with superlinear returns.** Your curiosity won't let you be interested in boring questions, and interesting questions tend to create fields with superlinear returns if they're not already part of one.
...
1. **Returns for performance are superlinear, not linear** - If your product is half as good, you don't get half the customers, you get none
2. **Two sources: exponential growth and thresholds** - Most situations have both
3. **Seek work that compounds** - Either directly (building infrastructure, audience) or by teaching you (learning compounds)
4. **Always be learning** - If you're not learning, you're probably not on a path to superlinear returns
5. **Follow curiosity, not careerism** - Promising questions seem mystifying but perhaps unimportant
6. **The territory is expanding** - Technology and decreasing importance of organizations is democratizing opportunity
7. **Do exceptionally good work** - At the far end of the curve, incremental effort is a bargain, and there's less competition because few even try
8. **Don't equate work with a job** - Your work is what you carry with you, part of your portfolio
9. **Take multiple shots** - Luck matters more when working independently, so start taking risks early
10. **Superlinear returns imply inequality** - Look for fields where a few big winners outperform everyone else

---

**Sources:**
- [Superlinear Returns](https://paulgraham.com/superlinear.html) - Paul Graham, October 2023
